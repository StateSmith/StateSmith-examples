...
typedef enum WaterCannonSm_StateId
{
    ...
    WaterCannonSm_StateId_CONFIRMATION = 5,
    WaterCannonSm_StateId_LOWER = 6,
    WaterCannonSm_StateId_RAISE = 7,
    WaterCannonSm_StateId_HOME = 8,
    WaterCannonSm_StateId_SPLASH_SCREEN = 9,
} WaterCannonSm_StateId;

enum
{
    WaterCannonSm_StateIdCount = 10
};
